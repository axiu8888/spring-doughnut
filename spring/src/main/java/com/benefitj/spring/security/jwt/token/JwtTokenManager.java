...
public class JwtTokenManager {
  ...
  public void setJwtOptions(JwtOptions jwtOptions) {
    this.jwtOptions = jwtOptions;
  }
  ...
  public JwtToken createAccessToken(JwtUserDetails user) {
    JwtOptions property = getJwtProperty();
  ...
  public JwtOptions getJwtProperty() {
    return jwtOptions;
  }
  ...
  public JwtToken parse(HttpServletRequest request) {
    String header = getJwtOptions().getTokenHeader();
    return parse(request.getHeader(header), false, false);
  }
