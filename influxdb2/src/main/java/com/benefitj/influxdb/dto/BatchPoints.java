...
public class BatchPoints {
  ...
  private InfluxApi.ConsistencyLevel consistency;
  ...
  public static final class Builder {
    ...
    /**
     * Set the ConsistencyLevel to use. If not given it defaults to {@link InfluxApi.ConsistencyLevel#ONE}
     *
     * @param consistencyLevel the ConsistencyLevel
     * @return the Builder instance
     */
    public Builder consistency(final InfluxApi.ConsistencyLevel consistencyLevel) {
    ...
    public BatchPoints build() {
      ...
      if (null == this.consistency) {
        this.consistency = InfluxApi.ConsistencyLevel.ONE;
      }
   ...
   */
  public InfluxApi.ConsistencyLevel getConsistency() {
   ...
   */
  void setConsistency(final InfluxApi.ConsistencyLevel consistency) {
