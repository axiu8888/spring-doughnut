...
public interface EntityFinder {
   ...
   * @return 返回获取的实体类
   */
  EntityDescriptor find(Class<?> klass, String typeParamName);

  /**
   * 直接获取实体类描述器
   */
  EntityDescriptor find(Class<?> type);
  ...
  class SimpleEntityFinder implements EntityFinder {
     ...
     */
    @Override
    public EntityDescriptor find(Class<?> klass, String typeParamName) {
    ...
    @Override
    public EntityDescriptor find(Class<?> type) {
