...
public class InfluxFieldKey {
  ...
  public InfluxFieldKey() {
  }

  public InfluxFieldKey(String column, boolean tag, int index) {
    this.column = column;
    this.tag = tag;
    this.index = index;
  ...
  public static final class Builder {
    ...
    public InfluxFieldKey build() {
      InfluxFieldKey fieldKey = new InfluxFieldKey();
