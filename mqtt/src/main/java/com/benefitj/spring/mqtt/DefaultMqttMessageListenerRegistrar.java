 ...
 * 默认的MQTT注册器
 */
public class DefaultMqttMessageListenerRegistrar implements
    MqttMessageListenerRegistrar, ApplicationEventPublisherAware, ApplicationContextAware {
  ...
  public DefaultMqttMessageListenerRegistrar(MqttOptionsProperty property,
